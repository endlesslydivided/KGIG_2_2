...
struct CMyPen
{
	...
	public: int PenWidth;				// Толщина пера 
...
public :  CMyPen PenAxis;		// Перо для осей
public:
	CPlot2D() { K.RedimMatrix(3, 3); };		// Изменяет размер матрицы с сохранением данных, которые можно сохранить
